...
Tags.Open = Class.create( Object.extend( {
	...
	initialize: function( element, options ){
		...
		this.newInput = new Element("input", { 'type': 'text', 'autocomplete': 'off'})
									...
									.observe('keypress', this.eventCommaPress.bindAsEventListener(this))//-IBR- keyup нам не подходит, ему все равно какой включен язык и буква б будет воспринята как ,
	...
	eventCommaPress: function(e){
		// 188 = comma
		//Debug.write( e.keyCode );
		//if( e.keyCode != 188 ) //fixed by denchu 2012 -IBR- чтобы б не работала как ,
