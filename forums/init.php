	...
	public static function defaultConstants()
	{
		...
		return array(
			...
			// to change them.
				...
				'SUITE_UNIQUE_KEY'	=> ( isset( $_SERVER['IPS_CIC'] ) and preg_match( '/^\/var\/www\/html\/(.+?)$/i', __DIR__, $matches ) ) ? str_replace( '/', '', $matches[1] ) : mb_substr( md5( '18e27' . '$Rev: 3023$'), 10, 10 ),
				'CACHEBUST_KEY'		=> mb_substr( md5( '18e27' . '$Rev: 3023$'), 10, 10 ),
...
//- IBR - Добавил в лог файл и строку
