...
$SQL[] = "INSERT INTO core_share_links VALUES(12, 'Вконтакте', 'http://vk.com/share.php?url={url}&amp;title={title}', 'vkontakte', 1, 12, '',1);";
$SQL[] = "INSERT INTO core_share_links VALUES(13, 'Одноклассники', 'http://www.odnoklassniki.ru/dk?st.cmd=addShare&amp;st._surl={url}&amp;title={title}', 'ok', 1, 13, '',1);";
