...
class version_upgrade
{
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		switch( $this->request['workact'] )
		{
			...
			case 'pmblock':
				...
				break;
			case 'polls':
				$this->rebuildPolls();//-IBR- после конвертации базы сериализованные масcивы портятся, этот этап восстанавливает опросы
				break;
			case 'finish':
				$this->finish();
				break;
	...
	public function addSettings()
	{
		...
		if ( ! $known['gb_char_set'] )
		{
			...
			$known['gb_char_set'] = 'utf-8';//выставляем кодировку в utf-8
		}
