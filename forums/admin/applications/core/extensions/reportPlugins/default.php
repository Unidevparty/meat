...
EOF;
	...
	protected function _getPageTitle( $URL )
	{
		...
		{
			return htmlentities( $match[1], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE, ( defined( 'IPS_DOC_CHAR_SET' ) )?IPS_DOC_CHAR_SET:ipsRegistry::$settings['gb_char_set']);//-IBR-иначе портит русские буквы на php < 5.4
		}
		else
		{
