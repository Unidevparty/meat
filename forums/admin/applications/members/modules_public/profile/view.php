	 ...
	 */
 	protected function _viewModern()
 	{
		...
		$friends	= $this->_getRandomFriends( $member );
			 ...
			 $member['members_seo_name'] = ( $member['members_seo_name'] ) ? $member['members_seo_name'] : IPSText::makeSeoTitle( $member['members_display_name'] );//-IBR-создаем seo_name если его еще не было, а то с пустым будут потом циклические редиректы
