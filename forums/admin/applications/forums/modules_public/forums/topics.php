...
class public_forums_forums_topics extends ipsCommand
{
	...
	public function doExecute( ipsRegistry $registry )
	{
		...
		$this->registry->output->addMetaTag( 'description', trim( $pageMeta . sprintf( $this->lang->words['topic_meta_description'], strip_tags( $topicData['title'] ), $forumData['name'], str_replace( array("\r","&nbsp;"), array(""," "), $this->_firstPostContent ) ) ), FALSE );
