...
$ENGINES['googlemobile'] = array(
							...
							'b_regex' => array( "(Mobile.*Googlebot|Google-Mobile)/([0-9.]{1,10})" => "\\\\2","(Mobile.*Googlebot|Google-Mobile)/" => "" )
						  );						  
...
$ENGINES['yahoo'] = array(
						  ...
						  );//-IBR-добавили всех известных ботов
...
$ENGINES['majestic'] = array(
							'b_title' => "Majestic12",
							'b_regex' => array( "MJ12bot[ /]v?([0-9.]{1,10})" => "1" )
						  );
						  
//Russian Search Engine Crawlers

$ENGINES['yandexmobile'] = array(
							'b_title' => "YandexMobile",
							'b_regex' => array( "YandexImageResizer[ /]([0-9.]{1,10})" => "1" )
						  );
$ENGINES['yandex'] = array(
							'b_title' => "Yandex",
							'b_regex' => array( "Yandex(Blogs|Blog|Bot|Images|Video|Media|Favicons|Webmaster|Pagechecker|Direct|Metrika|News|Newslinks|Catalog|Antivirus|Zakladki|Sitelinks|Vertis)?[ /]([0-9.]{1,10})" => "2" )
						  );
...
$ENGINES['mailru'] = array(
							'b_title' => "Mail.ru",
							'b_regex' => array( "Mail.(RU|ru|Ru|RU_Bot)[ /]([0-9.]{1,10})" => "2" )
						  );
