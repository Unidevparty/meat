...
//		$finalTables['members']['vk_uid']	 	            = isset($finalTables['members']['vk_uid']) ? $finalTables['members']['vk_uid'] : NULL;//-IBR- вконтекте
	...
	static public function buildNoPhoto( $member, $size=null, $noCache=false, $noBorder=false )
	{
		...
		if ( false and ipsRegistry::$settings['allow_gravatars'] and ! $member['bw_disable_gravatar'] ) //no gravatar default photo caching //-IBR- отключаем кешинг дефолтной аватарки по просьбам трудящихся. С ним связан ряд багов.
		{
