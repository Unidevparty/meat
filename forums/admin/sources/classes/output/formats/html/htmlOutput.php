...
class htmlOutput extends coreOutput implements interface_output 
{
	...
	public function printHeader()
	{
    	...
    	{	
			...
			if ( $this->_forceDownload )
			{
				...
				header( "Content-Disposition: attachment; filename=\"" . IPSText::alphanumericalClean( IPSText::transliterate( mb_strtolower( $this->registry->output->getTitle() ) ) )  . ".html\"" );//-IBR-транслитерация имультибайт для имени файла
			}
			else
			{
	...
	protected function html_fetchCopyright()
	{
        ...
        else
        {
        	$copyright = "<!-- Copyright Information -->
        				  <p id='copyright'>
        				  	<a href='http://www.invisionpower.com/apps/board/' title='Community Forum Software by Invision Power Services'>Community Forum Software by IP.Board{$version}</a><a href='http://www.ibresource.ru/products/ipboard/index.php?utm_source=cpr&utm_medium=copy&utm_compaign=346' title='Русская версия системы для сообществ от IBResource'> Русификация от IBResource</a>";//-IBR-
