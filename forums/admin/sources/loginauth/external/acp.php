...
$config		= array(
					...
					array(
							...
							'description'	=> "Поле таблицы удаленной базы, по которому будет проверяться login при авторизации на форуме",
					...
					array(
							'title'			=> 'Тип соединения с удаленной базой',
							'description'	=> "Используется для некоторых серверов баз данных, напр. MS-SQL",
							'key'			=> 'REMOTE_SQL_TYPE',
							'type'			=> 'string',
						),
					);