...
class admin_jawards_configuration_naked extends ipsCommand
{
	public function doExecute( ipsRegistry $registry )
	{
		...
		$settings->form_code    = $settings->html->form_code    = 'module=configuration&amp;section=naked';
		$settings->form_code_js = $settings->html->form_code_js = 'module=configuration&section=naked';		
		
		/* Some final stuff */
		$settings->return_after_save = $this->settings[ 'base_url' ] . $this->form_code;
		$this->request[ 'conf_title_keyword' ] = 'jappn';
