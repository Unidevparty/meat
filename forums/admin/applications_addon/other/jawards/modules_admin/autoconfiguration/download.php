...
class admin_jawards_autoconfiguration_download extends ipsCommand
{
	public function doExecute( ipsRegistry $registry )
	{
		...
		$settings->form_code    = $settings->html->form_code    = 'module=autoconfiguration&amp;section=download';
		$settings->form_code_js = $settings->html->form_code_js = 'module=autoconfiguration&section=download';		
		
		/* Some final stuff */
		$settings->return_after_save = $this->settings[ 'base_url' ] . $this->form_code;
		$this->request[ 'conf_title_keyword' ] = 'jaafu';
