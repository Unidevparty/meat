...
class fiLibrary
{
	...
	{
		return "<br /><div id='footer_utilities'><p id='copyright' class='right'>Powered By <a target='_blank' href='http://www.ipslink.pl'>" . $this->caches['app_cache']['forumicons']['app_title'] . " " . $this->caches['app_cache']['forumicons']['app_version'] . "</a> &copy; <a target='_blank' href='http://www.ipslink.pl' title='Custom mods, skins, support and more. We develop for you.'>IPSlink.pl</a></p></div>";
	}		
}// End of class