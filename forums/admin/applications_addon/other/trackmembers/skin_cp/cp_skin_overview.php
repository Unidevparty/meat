...
<table class='ipsTable double_pad'>
	<tr>
	    <td width='50%' valign='top'>
	        <div class="acp-box">
			    <h3>{$this->lang->words['mod']}: {$this->caches['app_cache']['trackmembers']['app_title']}</h3>
				<table class='ipsTable double_pad'>
					<tr>
					...
					<tr>
						<td colspan="2" align="center">
							<form target="_blank" action='https://www.paypal.com/cgi-bin/webscr' method='post'>
							         ...
							         <input type='hidden' name='item_name' value='Donate for TRACK MEMBER' />
							         <input type='hidden' name='no_note' value='1' />
							         <input type='hidden' name='currency_code' value='USD' />
							         <input type='hidden' name='on0' value='Nome' />
							         <input type='hidden' name='on1' value='Fórum' />
							         ...
							         <input type='image' src='https://www.paypal.com/en_US/i/btn/btn_donateCC_LG.gif' name='submit' alt='Donate to SOS Invision.' style='border:0px; background:transparent' />
							 </form>
						</td>
					<tr>
				</table>
