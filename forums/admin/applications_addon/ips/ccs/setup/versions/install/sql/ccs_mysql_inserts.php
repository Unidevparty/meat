...
$INSERT[]	= "INSERT INTO rc_classes (onoff, class_title, class_desc, author, author_url, pversion, my_class, extra_data, lockd, app) VALUES(1, 'Плагин IP.Content', 'Плагин системы жалоб для IP.Content. Позволяет оставлять жалобы на статьи и комментарии', 'Invision Power Services, Inc.', 'http://invisionpower.com', 'v1.0', 'ccs', 'N;', 1, 'ccs');";
