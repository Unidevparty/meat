...
$TABLE[]	= "CREATE TABLE ccs_databases (
  ...
  database_lang_slr VARCHAR( 255 ) NOT NULL DEFAULT '',
  database_lang_slv VARCHAR( 255 ) NOT NULL DEFAULT '',
  database_lang_pl VARCHAR( 255 ) NOT NULL DEFAULT '',
  database_lang_plr VARCHAR( 255 ) NOT NULL DEFAULT '',
  database_lang_plt VARCHAR( 255 ) NOT NULL DEFAULT '',
