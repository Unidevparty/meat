...
class admin_ccs_databases_databases extends ipsCommand
{
	...
	public function _databaseSave( $type='add' )
	{
		...
		$_save	= array(
						...
						'database_lang_slr'				=> trim($this->request['database_lang_slr']),
						'database_lang_slv'				=> trim($this->request['database_lang_slv']),
						'database_lang_pl'				=> trim($this->request['database_lang_pl']),
						'database_lang_plr'				=> trim($this->request['database_lang_plr']),
						'database_lang_plt'				=> trim($this->request['database_lang_plt']),
