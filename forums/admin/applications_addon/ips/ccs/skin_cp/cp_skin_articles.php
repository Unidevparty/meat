...
$singlowr		= $this->registry->output->formInput( 'database_lang_slr', $database['database_lang_slr'] ? $database['database_lang_slr'] : $this->lang->words['database_lang_slr'] );
$singlowv		= $this->registry->output->formInput( 'database_lang_slv', $database['database_lang_slv'] ? $database['database_lang_slv'] : $this->lang->words['database_lang_slv'] );
...
$plurallowr		= $this->registry->output->formInput( 'database_lang_plr', $database['database_lang_plr'] ? $database['database_lang_plr'] : $this->lang->words['database_lang_plr'] );
$plurallowt		= $this->registry->output->formInput( 'database_lang_plt', $database['database_lang_plt'] ? $database['database_lang_plt'] : $this->lang->words['database_lang_plt'] );
		...
		<div id='tabstrip_database_content' class='ipsTabBar_content'>
			...
			<div id='tab_1_content'>
				<table class='ipsTable double_pad'>
					...
					<tr>
						<td class='field_title'><strong class='title'>{$this->lang->words['langbits_sing_low_r']}</strong></td>
						<td class='field_field'>{$singlowr}</td>
					</tr>					
					<tr>
						<td class='field_title'><strong class='title'>{$this->lang->words['langbits_sing_low_v']}</strong></td>
						<td class='field_field'>{$singlowv}</td>
					</tr>
					<tr>
					...
					<tr>
						<td class='field_title'><strong class='title'>{$this->lang->words['langbits_plur_low_r']}</strong></td>
						<td class='field_field'>{$plurallowr}</td>
					</tr>					
					<tr>
						<td class='field_title'><strong class='title'>{$this->lang->words['langbits_plur_low_t']}</strong></td>
						<td class='field_field'>{$plurallowt}</td>
					</tr>
					<tr>
