	...
	public function fixStrings( $database, $forceRebuild=false )
	{
		...
		if( count($backup) )
		{
			foreach( $backup as $_k => $_v )
			{
				...
				$_v	= str_replace( "_RLSr_", $_database['database_lang_slr'] ? $_database['database_lang_slr'] : $this->registry->getClass('class_localization')->words['database_lang_slr'], $_v );
				$_v	= str_replace( "_RLSv_", $_database['database_lang_slv'] ? $_database['database_lang_slv'] : $this->registry->getClass('class_localization')->words['database_lang_slv'], $_v );
				...
				$_v	= str_replace( "_RLPr_", $_database['database_lang_plr'] ? $_database['database_lang_plr'] : $this->registry->getClass('class_localization')->words['database_lang_plr'], $_v );
				$_v	= str_replace( "_RLPt_", $_database['database_lang_plt'] ? $_database['database_lang_plt'] : $this->registry->getClass('class_localization')->words['database_lang_plt'], $_v );
		...
		else
		{
			...
			{
				if( strpos( $_v, '_RUS_' ) !== false OR strpos( $_v, '_RUP_' ) !== false OR strpos( $_v, '_RLS_' ) !== false OR strpos( $_v, '_RLP_' ) !== false OR strpos( $_v, '_RLSr_' ) !== false OR strpos( $_v, '_RLSv_' ) !== false OR strpos( $_v, '_RLPr_' ) !== false OR strpos( $_v, '_RLPt_' ) !== false)
				{
					$backup[ $_k ]	= $_v;
