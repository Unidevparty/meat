...
class skin_setup extends output
{
	 ...
	 */
	 ...
	 //-IBR- кодировка базы данных может быть любой, если это utf-8. Если не проверить сразу, то после обновления будет поздно.
...
$IPBHTML .= <<<EOF
	<div class='message error'>
		...
		<p>
			Кодировка таблиц базы данных должна быть установлена в utf8(utf8_general_ci или utf8_unicode_ci).
 			<br />
...
$IPBHTML .= <<<EOF
    <ul id='links'>
        ...
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://clientarea.ibresource.ru'>Клиент-центр</a></li>
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://external.ipslink.com/ipboard30/landing/?p=docs-ipb'>Документация</a></li>
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://forums.ibresource.ru'>Форумы IBResource</a></li>
    </ul>
EOF;
