(function() {
	CKEDITOR.dialog.add("lightbox", function(g) {
		...
		var l = CKEDITOR.plugins.link,
            ...
            gal_id = function(a){
                return gal!="" ? gal : 'dafault_gallery';
            },
			width = function(a) {
				return imgWidth = this.getValue() || ""
			},
			height = function(a) {
				return imgHeight = this.getValue() || ""
			},
            e = false,
		...
		return {
			...
			onShow: function() {
                ...
                e = true;
                gal = c.getAttribute('data-fancybox-saved');
			...
			onOk: function() {
				...
				var b = g.getSelection(),
                    ...
                    c.set['data-fancybox-saved'] = gal;
                    c.set['data-fancybox'] = gal_id();
                    typeof c.set['title'] !== 'undefined' ? c.set['data-caption'] = c.set['title'] : c.removed.push('data-caption');
				if (this._.selectedElement) {
					...
					delete this._.selectedElement
                               ...
                               if (b.collapsed) {
									   ...
									   if (imgWidth) a.setAttribute('width', imgWidth);
									   if (imgHeight) a.setAttribute('height', imgHeight);
                                       b.insertNode(a);
